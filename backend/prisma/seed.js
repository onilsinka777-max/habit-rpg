...
const templates = [
  ...
  // ===== ФИТНЕС — обязательные =====
  { title: "Сделать 15 приседаний", branch: "fitness", type: "required", difficulty: "easy", minLevel: 1 },
  { title: "Сделать 10 отжиманий", branch: "fitness", type: "required", difficulty: "easy", minLevel: 1 },
  ...
  { title: "Сделать 20 выпадов на обе ноги", branch: "fitness", type: "required", difficulty: "medium", minLevel: 3 },
  { title: "Сделать 5-минутный раунд: отжимания, приседания, прыжки", branch: "fitness", type: "required", difficulty: "hard", minLevel: 6 },
  { title: "Сделать 40 приседаний без остановки", branch: "fitness", type: "required", difficulty: "hard", minLevel: 6 },
  ...
  { title: "Сделать 10 вращений плечами в каждую сторону", branch: "fitness", type: "recommended", difficulty: "easy", minLevel: 1 },
  ...
  { title: "Сделать 20 приседаний и 15 отжиманий подряд", branch: "fitness", type: "recommended", difficulty: "medium", minLevel: 3 },
  { title: "Сделать планку 1 минуту", branch: "fitness", type: "recommended", difficulty: "medium", minLevel: 3 },
  { title: "Сделать 15 берпи", branch: "fitness", type: "recommended", difficulty: "medium", minLevel: 3 },
  { title: "Сделать 5-минутную растяжку всего тела", branch: "fitness", type: "recommended", difficulty: "medium", minLevel: 3 },
  { title: "Сделать 30 отжиманий за один подход", branch: "fitness", type: "recommended", difficulty: "hard", minLevel: 6 },
  { title: "Сделать 50 приседаний без остановки", branch: "fitness", type: "recommended", difficulty: "hard", minLevel: 6 },
  { title: "Сделать 5-минутный спринт на месте", branch: "fitness", type: "recommended", difficulty: "hard", minLevel: 6 },
  { title: "Сделать круг: 20 приседаний, 15 отжиманий, 1 минута планки", branch: "fitness", type: "recommended", difficulty: "hard", minLevel: 6 },

  // ===== САМОРАЗВИТИЕ — обязательные =====
  { title: "Прочитать 5 страниц книги", branch: "self_development", type: "required", difficulty: "easy", minLevel: 1 },
  ...
  { title: "Прочитать одну страницу учебника или статьи", branch: "knowledge", type: "required", difficulty: "easy", minLevel: 1 },
  { title: "Пройти один урок иностранного языка в приложении", branch: "knowledge", type: "required", difficulty: "medium", minLevel: 3 },
  { title: "Решить 3 задачи по теме, которую изучаешь", branch: "knowledge", type: "required", difficulty: "medium", minLevel: 3 },
  ...
  { title: "Выучить одно новое слово на иностранном языке", branch: "knowledge", type: "recommended", difficulty: "easy", minLevel: 1 },
  { title: "Посмотреть инфографику или схему по теме обучения", branch: "knowledge", type: "recommended", difficulty: "easy", minLevel: 1 },
  { title: "Решить 5 задач по теме, которую изучаешь", branch: "knowledge", type: "recommended", difficulty: "medium", minLevel: 3 },
  { title: "Изучить значение 5 новых терминов", branch: "knowledge", type: "recommended", difficulty: "medium", minLevel: 3 },
