...
INSERT INTO "new_User" ("clanId", "clanRole", "createdAt", "email", "gold", "goldBoostExpiresAt", "goldBoostPermanent", "hasEverFinishedMastery", "id", "lastActiveAt", "lastLoginBonusDate", "lastMasteryQuestDate", "lastTaskDate", "level", "masteryNodeIndex", "masteryPath", "name", "password", "streak", "streakFreezeCount", "xp", "xpBoostExpiresAt", "xpBoostPermanent") SELECT "clanId", "clanRole", "createdAt", "email", "gold", "goldBoostExpiresAt", "goldBoostPermanent", "hasEverFinishedMastery", "id", "lastActiveAt", "lastLoginBonusDate", "lastMasteryQuestDate", "lastTaskDate", "level", "masteryNodeIndex", "masteryPath", "name", "password", "streak", "streakFreezeCount", "xp", "xpBoostExpiresAt", "xpBoostPermanent" FROM "User";
DROP TABLE "User";
