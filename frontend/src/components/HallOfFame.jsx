...
export default function HallOfFame({ token }) {
  ...
  return (
    <div style={{ position:"relative", overflow:"hidden", borderRadius:16, paddingBottom:24,
      ...
      {/* Gold side lines */}
      <div style={{ position:"absolute", left:16, top:0, bottom:0, width:1, zIndex:1, pointerEvents:"none",
        background:"linear-gradient(180deg,transparent,rgba(245,182,55,0.3),rgba(245,182,55,0.15),transparent)" }}/>
      <div style={{ position:"absolute", right:16, top:0, bottom:0, width:1, zIndex:1, pointerEvents:"none",
        background:"linear-gradient(180deg,transparent,rgba(245,182,55,0.3),rgba(245,182,55,0.15),transparent)" }}/>

      {/* Torch decorations — inline at top corners */}
      <div style={{ position:"absolute", left:0, top:0, zIndex:2, pointerEvents:"none",
        display:"flex", flexDirection:"column", alignItems:"center", padding:"8px 4px 0" }}>
        <div style={{ position:"relative", width:14, height:22 }}>
          <div style={{ position:"absolute", bottom:0, left:"50%", transform:"translateX(-50%)",
            width:12, height:18, background:"linear-gradient(180deg,#fff7c0,#f5b637,#ef4444)",
            borderRadius:"50% 50% 30% 30%", animation:"hofFlickerleft 1.2s ease-in-out infinite",
            boxShadow:"0 0 10px #f5b637, 0 0 20px rgba(245,182,55,0.4)" }}/>
        </div>
        <div style={{ width:5, height:50, borderRadius:3,
          background:"linear-gradient(180deg,rgba(245,182,55,0.4),rgba(100,70,20,0.6))" }}/>
        <div style={{ width:12, height:5, borderRadius:3, background:"rgba(245,182,55,0.3)" }}/>
      </div>

      <div style={{ position:"absolute", right:0, top:0, zIndex:2, pointerEvents:"none",
        display:"flex", flexDirection:"column", alignItems:"center", padding:"8px 4px 0" }}>
        <div style={{ position:"relative", width:14, height:22 }}>
          <div style={{ position:"absolute", bottom:0, left:"50%", transform:"translateX(-50%)",
            width:12, height:18, background:"linear-gradient(180deg,#fff7c0,#f5b637,#ef4444)",
            borderRadius:"50% 50% 30% 30%", animation:"hofFlickerright 1.6s ease-in-out infinite",
            boxShadow:"0 0 10px #f5b637, 0 0 20px rgba(245,182,55,0.4)" }}/>
        </div>
        <div style={{ width:5, height:50, borderRadius:3,
          background:"linear-gradient(180deg,rgba(245,182,55,0.4),rgba(100,70,20,0.6))" }}/>
      ...
      {/* Content */}
      <div style={{ position:"relative", zIndex:10, maxWidth:560, margin:"0 auto", padding:"24px 16px" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:24 }}>
          ...
          <div style={{ fontSize:11, color:"rgba(245,182,55,0.4)", marginTop:4, letterSpacing:2 }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:8, margin:"14px 0 0" }}>
            ...
            <span style={{ fontSize:12, color:"rgba(245,182,55,0.5)" }}>✦</span>
        ...
        <div style={{
          ...
          border:"1px solid rgba(245,182,55,0.15)", overflow:"hidden",
          boxShadow:"0 4px 40px rgba(0,0,0,0.6), inset 0 1px 0 rgba(245,182,55,0.08)",
        }}>
          {/* Table header */}
          <div style={{ display:"grid", gridTemplateColumns:"32px 1fr 80px 60px 70px",
            gap:8, padding:"8px 14px",
            background:"rgba(245,182,55,0.05)", borderBottom:"1px solid rgba(245,182,55,0.1)" }}>
          ...
          <div style={{
            ...
            <div style={{ display:"flex", alignItems:"center", gap:6 }}>
              <span style={{ fontWeight:900, fontSize:15,
                ...
                WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>LAPTEV</span>
              <div style={{ display:"flex", gap:4 }}>
                {SOCIALS.map(s => (
                  <a key={s.icon} href={s.url} target="_blank" rel="noopener noreferrer"
                    style={{ fontSize:11, textDecoration:"none", opacity:0.7, transition:"opacity 0.15s" }}
            ...
            <>
              ...
              {Array.from({length: Math.max(0, 9 - winners.length)}, (_, i) => (
                <div key={`empty-${i}`} style={{
                  display:"grid", gridTemplateColumns:"32px 1fr 80px 60px 70px",
                  gap:8, padding:"10px 14px", alignItems:"center",
                  borderBottom:"1px dashed rgba(245,182,55,0.06)", opacity:0.4,
                }}>
                  <div style={{
                    width:32, height:32, borderRadius:"50%", flexShrink:0,
                  ...
                  <div style={{ fontSize:12, color:"rgba(255,255,255,0.15)", fontStyle:"italic" }}>- - - ожидает героя - - -</div>
